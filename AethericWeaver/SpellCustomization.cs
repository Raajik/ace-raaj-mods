    ...
    public class SpellCustomization
{
    ...
    // Applies any non-null customization values to a SpellBase and database Spell row
    ...
    // Tries to open and map a customization spreadsheet, optionally creating a default one
    ...
    // Creates a default spreadsheet with a single example spell row
