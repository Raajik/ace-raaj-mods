...
[CommandCategory(nameof(AlterationFeature.CorpseInfo))]
[HarmonyPatchCategory(nameof(AlterationFeature.CorpseInfo))]
public class CorpseInfo
{
    ...
    public static bool PreCreateCorpse(DamageHistoryInfo killer, bool hadVitae, ref Creature __instance)
    {
        ...
        // Stub / diagnostic corpse path — extend before relying on in production.
        ...
        if (player != null)
        {
            // Known rough edge: verify landblock/corpse timing if this fires incorrectly.
