...
[CommandCategory(nameof(AlterationFeature.FakeItemLoot))]
[HarmonyPatchCategory(nameof(AlterationFeature.FakeItemLoot))]
internal class FakeItemLoot
{
    ...
    public static bool PreGenerateTreasure(DamageHistoryInfo killer, Corpse corpse, ref Creature __instance, ref List<WorldObject> __result)
    {
        ...
        if (killer is { IsPlayer: true } && killer.TryGetPetOwnerOrAttacker() is Player player && lootProfile is not null)
        {
            replaceProfile = true;
