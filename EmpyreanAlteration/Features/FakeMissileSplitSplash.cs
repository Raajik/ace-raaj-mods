...
[CommandCategory(nameof(AlterationFeature.FakeMissileSplitSplash))]
[HarmonyPatchCategory(nameof(AlterationFeature.FakeMissileSplitSplash))]
internal class FakeMissileSplitSplash
{
    ...
    {
        // Requires ammo context from the missile path; no ammo-less branch yet.
    ...
    {
        // Same ammo requirement as primary missile.
        var ammo = weapon.IsAmmoLauncher ? player.GetEquippedAmmo() : weapon;
        var projectileSpeed = player.GetProjectileSpeed();
