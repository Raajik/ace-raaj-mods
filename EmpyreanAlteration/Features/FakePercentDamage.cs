...
[CommandCategory(nameof(AlterationFeature.FakePercentDamage))]
[HarmonyPatchCategory(nameof(AlterationFeature.FakePercentDamage))]
public static class FakePercentDamage
{
    ...
    // Possible refactor: build fake damage from a shared helper mirroring DamageEvent fields.
