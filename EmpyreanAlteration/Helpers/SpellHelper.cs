...
namespace EmpyreanAlteration.Helpers;
...
//    {
//        if (!File.Exists(PatchClass.Settings.SpellSettings.PortalDatPath))
//        {
...
//        // Note: clean this up and verify if re-enabled.
//        try
//        {
//            //Load comparable map
//            if (File.Exists(_groupPath) && PatchClass.Settings.SpellSettings.LastGenerated == PatchClass.Settings.SpellSettings.GroupType)
//            {
...
//                PatchClass.Settings.SpellSettings.LastGenerated = PatchClass.Settings.SpellSettings.GroupType;
//                S.SaveSettings();
//            }
//        }
//        catch (Exception ex)
...
//    {
//        var portalDat = new PortalDatDatabase(PatchClass.Settings.SpellSettings.PortalDatPath, false);
...
//        #region Group Dump
//        if (!PatchClass.Settings.SpellSettings.DumpSpellGroups)
//            return;
