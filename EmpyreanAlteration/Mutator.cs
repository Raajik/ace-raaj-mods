...
{
    // Targeting is by WeenieTypeTargets, TreasureTargets (when wired), and Odds tier rolls — configure those on each mutator instance.
    ...
    {
        if (TreasureTargets is null || TreasureTargets.Count == 0)
            return true;
    ...
    // Failed mutations return false; callers log or continue without throwing.
