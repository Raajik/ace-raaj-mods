...
Future mod or feature concepts for this repo. Not committed work—use per-mod `TODO.md` for active tasks when a mod has backlog worth tracking (mods with no open work may omit that file).
