...
- **Loot stack consolidation** — merges duplicate same-WCID stackable rows in freshly generated corpses (e.g. multiple drudge charm create-list entries). Drudge charm **Quality / Pristine / Perfect** WCIDs **850271–850273** (+ base **24835** Bloodletter) — SQL `WindblownContent/Content/SQL/DrudgeCharm_TierWeenies_World.sql`, clone template `WindblownContent/Content/SQL/README-TrophyCharmCloneTemplate.md`.
