...
public class Stunner : CreatureEx
{
    ...
    // Custom behavior: full retail-style stun was not enabled here — motion-only broadcasts without a proper combat lock looked wrong on clients. The interval is kept as a cheap hook if you add a real CC later.
    ...
    public override void Heartbeat(double currentUnixTime)
    {
        ...
        //{
        //    // If re-enabled: pair motion with the correct cancel/fail hooks (cast, attack done, etc.).
