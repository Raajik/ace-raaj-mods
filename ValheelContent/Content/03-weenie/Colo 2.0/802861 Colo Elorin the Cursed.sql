...
VALUES (802861, 'ColoElorinTheCursed', 10, '2023-06-30 08:59:48') /* Creature */;
...
VALUES (802861,   1,       2) /* HeartbeatInterval */
     ...
     , (802861,   5,       1) /* ManaRate */
     , (802861,  13,       1) /* ArmorModVsSlash */
     , (802861,  14,       1) /* ArmorModVsPierce */
     , (802861,  15,       1) /* ArmorModVsBludgeon */
     , (802861,  16,     1.3) /* ArmorModVsCold */
     , (802861,  17,       1) /* ArmorModVsFire */
     , (802861,  18,       1) /* ArmorModVsAcid */
     , (802861,  19,     1.3) /* ArmorModVsElectric */
     ...
     , (802861,  68,    0.03) /* ResistCold */
     , (802861,  69,    0.01) /* ResistAcid */
     , (802861,  70,    0.03) /* ResistElectric */
     ...
     , (802861, 125,       1) /* ResistHealthDrain */
     , (802861, 166,    0.01) /* ResistNether */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (802861,   1, 'Elorin the Cursed') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (802861,   1,   33554433) /* Setup */
     , (802861,   2,  150994945) /* MotionTable */
     , (802861,   3,  536870913) /* SoundTable */
     , (802861,   4,  805306368) /* CombatTable */
     , (802861,   7,  268437336) /* ClothingBase */
     , (802861,   8,  100667446) /* Icon */
     , (802861,  22,  872415236) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (802861,  0,  4, 15000, 0.75, 2900,  600,  600,  600,  600,  600,  600,  600,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (802861,  1,  4, 15000, 0.75, 2900,  600,  600,  600,  600,  600,  600,  600,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (802861,  2,  4, 15000, 0.75, 2900,  600,  600,  600,  600,  600,  600,  600,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (802861,  3,  4, 15000, 0.75, 2900,  600,  600,  600,  600,  600,  600,  600,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (802861,  4,  4, 15000, 0.75, 2900,  600,  600,  600,  600,  600,  600,  600,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (802861,  5,  4, 15000, 0.75, 2900,  600,  600,  600,  600,  600,  600,  600,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (802861,  6,  4, 15000, 0.75, 2900,  600,  600,  600,  600,  600,  600,  600,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (802861,  7,  4, 15000, 0.75, 2900,  600,  600,  600,  600,  600,  600,  600,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (802861,  8,  4, 15000, 0.75, 2900,  600,  600,  600,  600,  600,  600,  600,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (802861,   1,2500, 0, 0) /* Strength */
...
VALUES (802861,   1,900000, 0, 0,900000) /* MaxHealth */
...
VALUES (802861, 2,802728,  1,93,    0, False) /* Create Gaerlan's Drain Ring for Wield */
     , (802861, 9,802730,  0,0,     0.1, False) /* Create Elemental Prism for ContainTreasure */
     , (802861, 9,     0,  0,0,     0.9, False) /* Create Nothing for ContainTreasure */;
