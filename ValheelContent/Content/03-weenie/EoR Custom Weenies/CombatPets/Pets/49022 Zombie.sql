...
VALUES (49022,   1, 500, 0, 0) /* Strength */
     , (49022,   2, 500, 0, 0) /* Endurance */
     , (49022,   3, 500, 0, 0) /* Quickness */
     , (49022,   4, 500, 0, 0) /* Coordination */
     , (49022,   5, 500, 0, 0) /* Focus */
     , (49022,   6, 500, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (49022,   1,  25000, 0, 0, 25000) /* MaxHealth */
...
VALUES (49022,  0, 16,  0,    0,  570,  570,  570,  570,  570,  570,  570,  570,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (49022,  5, 16, 3500, 0.75,  570,  570,  570,  570,  570,  570,  570,  570,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (49022,  8, 16, 3500, 0.75,  570,  570,  570,  570,  570,  570,  570,  570,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (49022, 2, 48991,  1, 1, 0, False) /* Create Flaming Hatchet (48991) for Wield */
     , (49022, 2,  15865,  1, 9, 0.1, False) /* Create Doublet (2596) for Wield */
