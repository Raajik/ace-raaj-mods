...
VALUES (49163,   1,   33561478) /* Setup */
     ...
     , (49163,   7,  268437548) /* ClothingBase */
     , (49163,   8,  100671323) /* Icon */
     , (49163,  22,  872415269) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (49163,   1, 500, 0, 0) /* Strength */
     , (49163,   2, 500, 0, 0) /* Endurance */
     , (49163,   3, 500, 0, 0) /* Quickness */
     , (49163,   4, 500, 0, 0) /* Coordination */
     , (49163,   5, 500, 0, 0) /* Focus */
     , (49163,   6, 500, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (49163,   1,  25000, 0, 0, 25000) /* MaxHealth */
...
VALUES (49163,  0,  8, 3500, 0.75,  570,  570,  570,  570,  570,  570,  570,  570,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (49163,  5,  8, 3500, 0.75,  570,  570,  570,  570,  570,  570,  570,  570,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (49163,  8,  8, 3500, 0.75,  570,  570,  570,  570,  570,  570,  570,  570,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (49163, 2, 15865,  0,93,  0.2, False) /* Create Olthoi Amuli Leggings (37201) for Wield */;
