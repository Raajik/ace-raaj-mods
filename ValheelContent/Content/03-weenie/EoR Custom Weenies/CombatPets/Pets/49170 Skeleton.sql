...
VALUES (49170,   1, 500, 0, 0) /* Strength */
     , (49170,   2, 500, 0, 0) /* Endurance */
     , (49170,   3, 500, 0, 0) /* Quickness */
     , (49170,   4, 500, 0, 0) /* Coordination */
     , (49170,   5, 500, 0, 0) /* Focus */
     , (49170,   6, 500, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (49170,   1,  25000, 0, 0, 25000) /* MaxHealth */
...
VALUES (49170,  0, 32, 3500, 0.75,  570,  570,  570,  570,  570,  570,  570,  570,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (49170,  5, 32, 3500, 0.75,  570,  570,  570,  570,  570,  570,  570,  570,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (49170,  8, 32, 3500, 0.75,  570,  570,  570,  570,  570,  570,  570,  570,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (49170, 2, 15865,  0,93,  0.2, False) /* Create Olthoi Amuli Leggings (37201) for Wield */;
