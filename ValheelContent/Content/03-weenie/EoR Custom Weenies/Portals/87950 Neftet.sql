...
VALUES (87950,   1, 'Neftet') /* Name */
     , (87950,  37, 'Transcendence') /* QuestRestriction */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (87950,   1,   33556212) /* Setup */
     , (87950,   2,  150994947) /* MotionTable */
     , (87950,   8,  100667499) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (87950, 2, 2271412238, 40.4574, 129.281, 8.005, 0.707107, 0, 0, 0.707107) /* Destination */
