...
VALUES (51728, 'ace51728-discorporaterynthidofrage', 10, '2022-12-28 05:57:21') /* Creature */;
...
VALUES (51728,   1,   33561550) /* Setup */
     ...
     , (51728,  35,       2110) /* DeathTreasureType */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (51728,   1, 1200, 0, 0) /* Strength */
...
VALUES (51728,   1,   60000, 0, 0, 60000) /* MaxHealth */
     , (51728,   3,   60000, 0, 0, 60000) /* MaxStamina */
     , (51728,   5,   60000, 0, 0, 60000) /* MaxMana */;
...
VALUES (51728,  0, 16,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51728,  1, 16,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51728,  2, 16,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51728,  3, 16,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51728,  4, 16,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51728,  5, 16, 1500,  0.5,  550,  440,  550,  550,  550,  440,  440,  550,  550, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51728,  6, 16,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51728,  7, 16,  0,    0,  550,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51728,  8, 16, 1500,  0.5,  550,  440,  550,  550,  550,  440,  440,  550,  550, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
