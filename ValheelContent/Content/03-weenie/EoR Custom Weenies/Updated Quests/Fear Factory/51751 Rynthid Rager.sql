...
VALUES (51751, 'ace51751-rynthidrager', 10, '2022-12-28 05:57:21') /* Creature */;
...
VALUES (51751,   1,       5) /* HeartbeatInterval */
     ...
     , (51751,  16,       1) /* ArmorModVsCold */
     , (51751,  17,     0.9) /* ArmorModVsFire */
     , (51751,  18,     0.9) /* ArmorModVsAcid */
     , (51751,  19,       1) /* ArmorModVsElectric */
...
VALUES (51751,   1,   33561562) /* Setup */
     ...
     , (51751,  35,       2110) /* DeathTreasureType */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (51751,   1, 1200, 0, 0) /* Strength */
...
VALUES (51751,   1,  60000, 0, 0, 60000) /* MaxHealth */
     , (51751,   3,  60000, 0, 0, 60000) /* MaxStamina */
     , (51751,   5,  60000, 0, 0, 60000) /* MaxMana */;
...
VALUES (51751,  0, 16,  0,    0,  650,  585,  650,  650,  650,  585,  585,  650,  650, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51751,  1, 16,  0,    0,  650,  585,  650,  650,  650,  585,  585,  650,  650, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51751,  2, 16,  0,    0,  650,  585,  650,  650,  650,  585,  585,  650,  650, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51751,  3, 16,  0,    0,  650,  585,  650,  650,  650,  585,  585,  650,  650, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51751,  4, 16,  0,    0,  650,  585,  650,  650,  650,  585,  585,  650,  650, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51751,  5, 16, 1500,  0.5,  650,  585,  650,  650,  650,  585,  585,  650,  650, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51751,  6, 16,  0,    0,  650,  585,  650,  650,  650,  585,  585,  650,  650, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51751,  7, 16,  0,    0,  650,  585,  650,  650,  650,  585,  585,  650,  650, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51751,  8, 16, 1500,  0.5,  650,  585,  650,  650,  650,  585,  585,  650,  650, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
