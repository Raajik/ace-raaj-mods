...
VALUES (51902, 'ace51902-lugianlackey', 10, '2022-12-04 19:04:52') /* Creature */;
...
VALUES (51902,   1,       5) /* HeartbeatInterval */
     ...
     , (51902, 165,       1) /* ArmorModVsNether */
     , (51902, 166,       1) /* ResistNether */;
...
VALUES (51902,   1,   33557003) /* Setup */
     ...
     , (51902,  35,       1000) /* DeathTreasureType */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (51902,   1, 1200, 0, 0) /* Strength */
...
VALUES (51902,   1,  60000, 0, 0, 60000) /* MaxHealth */
     , (51902,   3,  60000, 0, 0, 60000) /* MaxStamina */
     , (51902,   5,  60000, 0, 0, 60000) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (51902,  6, 0, 2, 0, 560, 0, 0) /* MeleeDefense        Trained */
     , (51902,  7, 0, 2, 0, 450, 0, 0) /* MissileDefense      Trained */
     , (51902, 15, 0, 2, 0, 380, 0, 0) /* MagicDefense        Trained */
     , (51902, 41, 0, 2, 0, 400, 0, 0) /* TwoHandedCombat     Trained */
     , (51902, 44, 0, 2, 0, 400, 0, 0) /* HeavyWeapons        Trained */
     , (51902, 45, 0, 2, 0, 400, 0, 0) /* LightWeapons        Trained */
     , (51902, 46, 0, 2, 0, 400, 0, 0) /* FinesseWeapons      Trained */
     , (51902, 47, 0, 2, 0, 450, 0, 0) /* MissileWeapons      Trained */
     , (51902, 52, 0, 2, 0, 400, 0, 0) /* DirtyFighting       Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51902,  0,  4, 1500,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51902,  1,  4, 1500,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51902,  2,  4, 1500,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51902,  3,  4, 1500,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51902,  4,  4, 1500,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51902,  5,  4, 1500, 0.75,  440,  440,  352,  440,  352,  440,  440,  352,  440, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (51902,  6,  4, 1500,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51902,  7,  4, 1500,  0.3,  440,  440,  352,  440,  352,  440,  440,  352,  440, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51902,  8,  4, 1500, 0.75,  440,  440,  352,  440,  352,  440,  440,  352,  440, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
