...
VALUES (46143, 'ace46143-babypenguin', 10, '2023-05-15 03:25:02') /* Creature */;
...
VALUES (46143,   1,   33559122) /* Setup */
     ...
     , (46143,  35,        127) /* DeathTreasureType */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (46143,   1,  500, 0, 0) /* Strength */
...
VALUES (46143,   1,   30000, 0, 0, 30000) /* MaxHealth */
     , (46143,   3,   30000, 0, 0, 30000) /* MaxStamina */
...
VALUES (46143,  0,  2,  5,  0.6,  100,  130,  100,  110,   98,   80,  100,   98,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (46143,  1,  4, 1500,  0.3,  100,  130,  100,  110,   98,   80,  100,   98,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (46143,  2,  4, 1500,  0.4,  100,  130,  100,  110,   98,   80,  100,   98,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (46143,  3,  4, 1500,  0.3,  100,  130,  100,  110,   98,   80,  100,   98,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (46143,  4,  4, 1500,  0.4,  100,  130,  100,  110,   98,   80,  100,   98,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (46143,  5,  4,  5,  0.4,  100,  130,  100,  110,   98,   80,  100,   98,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (46143,  6,  4, 1500,  0.3,  100,  130,  100,  110,   98,   80,  100,   98,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (46143,  7,  4, 1500,  0.4,  100,  130,  100,  110,   98,   80,  100,   98,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (46143,  8,  4,  5,  0.4,  100,  130,  100,  110,   98,   80,  100,   98,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (46143,  5 /* HeartBeat */,  0.172, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (46143,  5 /* HeartBeat */,  0.272, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (46143,  5 /* HeartBeat */,  0.372, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (46143,  5 /* HeartBeat */,  0.472, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
