...
VALUES (32833,   1,   33554433) /* Setup */
     ...
     , (32833,  35,        454) /* DeathTreasureType */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (32833,   1, 1200, 0, 0) /* Strength */
     , (32833,   2, 400, 0, 0) /* Endurance */
     , (32833,   3, 400, 0, 0) /* Quickness */
     , (32833,   4, 400, 0, 0) /* Coordination */
     , (32833,   5, 400, 0, 0) /* Focus */
     , (32833,   6, 400, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (32833,   1,   100760, 0, 0, 100760) /* MaxHealth */
     , (32833,   3,    50000, 0, 0, 50000) /* MaxStamina */
     , (32833,   5,    50000, 0, 0, 50000) /* MaxMana */;
...
VALUES (32833,  0,  4,  0,    0,  544,  490,  544,  544,  435,  435,  218,  326,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (32833,  5,  4, 3500,  0.4,  544,  490,  544,  544,  435,  435,  218,  326,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (32833,  8,  4, 3500,  0.4,  544,  490,  544,  544,  435,  435,  218,  326,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
