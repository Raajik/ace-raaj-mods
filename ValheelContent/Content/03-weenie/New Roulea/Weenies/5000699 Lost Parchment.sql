...
VALUES (5000699,   1,   33554773) /* Setup */
     , (5000699,   3,  536870932) /* SoundTable */
     , (5000699,   8,  100668176) /* Icon */
     , (5000699,  22,  872415275) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5000699, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000699, 1, 4294967295, '', 'prewritten', False, 'This note was written on clean paper in a neat hand.
