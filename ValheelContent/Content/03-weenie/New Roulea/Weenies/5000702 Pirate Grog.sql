DELETE FROM `weenie` WHERE `class_Id` = 5000702;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (5000702, 'ace5000702-cryptswildturkey', 18, '2020-01-17 12:55:09') /* Food */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (5000702,   1,         32) /* ItemType - Food */
     , (5000702,   5,          1) /* EncumbranceVal */
     , (5000702,  11,        250) /* MaxStackSize */
     , (5000702,  12,          1) /* StackSize */
     , (5000702,  16,          8) /* ItemUseable - Contained */
     , (5000702,  18,          1) /* UiEffects - Magical */
     , (5000702,  19,          2) /* Value */
     , (5000702,  53,        101) /* PlacementPosition - Resting */
     , (5000702,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (5000702,  94,         16) /* TargetType - Creature */
     , (5000702, 106,        300) /* ItemSpellcraft */
     , (5000702, 107,         50) /* ItemCurMana */
     , (5000702, 108,         50) /* ItemMaxMana */
     , (5000702, 109,          0) /* ItemDifficulty */
     , (5000702, 110,          0) /* ItemAllegianceRankLimit */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5000702,  11, True ) /* IgnoreCollisions */
     , (5000702,  13, True ) /* Ethereal */
     , (5000702,  14, True ) /* GravityStatus */
     , (5000702,  19, True ) /* Attackable */
     , (5000702,  22, True ) /* Inscribable */
     , (5000702,  69, False) /* IsSellable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (5000702,  39,     0.5) /* DefaultScale */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (5000702,   1, 'Pirate Grog') /* Name */
     , (5000702,   7, 'Drink Responsibly... Nah! ;p') /* Inscription */
     , (5000702,   8, 'TCK') /* ScribeName */
     , (5000702,  14, 'Use this item to Drink it.') /* Use */
     , (5000702,  16, 'A very strong beer.') /* LongDesc */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (5000702,   1,   33559128) /* Setup */
     , (5000702,   3,  536870932) /* SoundTable */
     , (5000702,   8,  100686437) /* Icon */
     , (5000702,  22,  872415275) /* PhysicsEffectTable */
     , (5000702,  28,       3738) /* Spell - Prodigal Strength */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5000702,  7 /* Use */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
