...
VALUES (802442,   1, 15000, 0, 0, 15000) /* MaxHealth */
     , (802442,   3, 800, 0, 0, 800) /* MaxStamina */
     , (802442,   5, 800, 0, 0, 800) /* MaxMana */;
...
VALUES (802442,  0,  4,  0,    0,  1340,  410,  350,  440,  440,  335,  440,  440,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (802442,  5,  4, 1000,  0.4,  1340,  410,  350,  440,  440,  335,  440,  440,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (802442,  8,  4, 1000,  0.4,  1340,  410,  355,  440,  440,  330,  440,  440,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
