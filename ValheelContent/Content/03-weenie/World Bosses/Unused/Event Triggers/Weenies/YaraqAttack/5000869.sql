    ...
    DELETE FROM `weenie` WHERE `class_Id` = 5000869;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (5000869, '5000869', 10, '2005-02-09 10:00:00') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (5000869,   1,         16) /* ItemType - Creature */
     , (5000869,   2,         31) /* CreatureType - Human */
     , (5000869,   6,         -1) /* ItemsCapacity */
     , (5000869,   7,         -1) /* ContainersCapacity */
     , (5000869,   8,        120) /* Mass */
     , (5000869,  16,          1) /* ItemUseable - No */
     , (5000869,  25,        115) /* Level */
     , (5000869,  27,          0) /* ArmorType - None */
     , (5000869,  40,          2) /* CombatMode - Melee */
     , (5000869,  68,         13) /* TargetingTactic - Random, LastDamager, TopDamager */
     , (5000869,  93,       1032) /* PhysicsState - ReportCollisions, Gravity */
     , (5000869, 101,        131) /* AiAllowedCombatStyle - Unarmed, OneHanded, ThrownWeapon */
     , (5000869, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (5000869, 146,      24650) /* XpOverride */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5000869,   1, True ) /* Stuck */
     , (5000869,  11, False) /* IgnoreCollisions */
     , (5000869,  12, True ) /* ReportCollisions */
     , (5000869,  13, False) /* Ethereal */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (5000869,   1,       5) /* HeartbeatInterval */
     , (5000869,   2,       0) /* HeartbeatTimestamp */
     , (5000869,   3,    0.16) /* HealthRate */
     , (5000869,   4,     2.5) /* StaminaRate */
     , (5000869,   5,       1) /* ManaRate */
     , (5000869,  13,     0.9) /* ArmorModVsSlash */
     , (5000869,  14,       1) /* ArmorModVsPierce */
     , (5000869,  15,     1.1) /* ArmorModVsBludgeon */
     , (5000869,  16,     0.4) /* ArmorModVsCold */
     , (5000869,  17,     0.4) /* ArmorModVsFire */
     , (5000869,  18,       1) /* ArmorModVsAcid */
     , (5000869,  19,     0.6) /* ArmorModVsElectric */
     , (5000869,  31,      30) /* VisualAwarenessRange */
     , (5000869,  64,    0.35) /* ResistSlash */
     , (5000869,  65,    0.35) /* ResistPierce */
     , (5000869,  66,    0.35) /* ResistBludgeon */
     , (5000869,  67,    0.35) /* ResistFire */
     , (5000869,  68,    0.35) /* ResistCold */
     , (5000869,  69,    0.35) /* ResistAcid */
     , (5000869,  70,    0.35) /* ResistElectric */
     , (5000869,  71,       1) /* ResistHealthBoost */
     , (5000869,  72,       1) /* ResistStaminaDrain */
     , (5000869,  73,       1) /* ResistStaminaBoost */
     , (5000869,  74,       1) /* ResistManaDrain */
     , (5000869,  75,       1) /* ResistManaBoost */
     , (5000869, 104,      10) /* ObviousRadarRange */
     , (5000869, 117,     0.5) /* FocusedProbability */
     , (5000869, 125,       1) /* ResistHealthDrain */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (5000869,   1, 'Cult Leader') /* Name */
     , (5000869,   3, 'Male') /* Sex */
     , (5000869,   4, 'Aluvian') /* HeritageGroup */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (5000869,   1,   33554433) /* Setup */
     , (5000869,   2,  150994945) /* MotionTable */
     , (5000869,   3,  536870913) /* SoundTable */
     , (5000869,   4,  805306368) /* CombatTable */
     , (5000869,   8,  100667446) /* Icon */
     , (5000869,  22,  872415236) /* PhysicsEffectTable */
     , (5000869,  32,        433) /* WieldedTreasureType - 
     ...
     , (5000869,  35,        452) /* DeathTreasureType - Loot Tier: 5 */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (5000869,   1, 230, 0, 0) /* Strength */
     , (5000869,   2, 200, 0, 0) /* Endurance */
     , (5000869,   3, 210, 0, 0) /* Quickness */
     , (5000869,   4, 230, 0, 0) /* Coordination */
     , (5000869,   5,  80, 0, 0) /* Focus */
     , (5000869,   6,  80, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (5000869,   1,   150, 0, 0, 250) /* MaxHealth */
     , (5000869,   3,   130, 0, 0, 330) /* MaxStamina */
     , (5000869,   5,     0, 0, 0, 80) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (5000869,  2, 0, 3, 0, 160, 0, 298.956752857342) /* Bow                 Specialized */
     , (5000869,  3, 0, 3, 0, 160, 0, 298.956752857342) /* Crossbow            Specialized */
     , (5000869,  4, 0, 3, 0,   0, 0, 298.956752857342) /* Dagger              Specialized */
     , (5000869,  6, 0, 3, 0, 275, 0, 298.956752857342) /* MeleeDefense        Specialized */
     , (5000869,  7, 0, 3, 0, 400, 0, 298.956752857342) /* MissileDefense      Specialized */
     , (5000869, 11, 0, 3, 0, 270, 0, 298.956752857342) /* Sword               Specialized */
     , (5000869, 12, 0, 3, 0, 160, 0, 298.956752857342) /* ThrownWeapon        Specialized */
     , (5000869, 14, 0, 3, 0, 250, 0, 298.956752857342) /* ArcaneLore          Specialized */
     , (5000869, 15, 0, 3, 0, 300, 0, 298.956752857342) /* MagicDefense        Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (5000869,  0,  4,  0,    0,  225,  203,  225,  248,   90,   90,  225,  135,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (5000869,  1,  4,  0,    0,  225,  203,  225,  248,   90,   90,  225,  135,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (5000869,  2,  4,  0,    0,  225,  203,  225,  248,   90,   90,  225,  135,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (5000869,  3,  4,  0,    0,  225,  203,  225,  248,   90,   90,  225,  135,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (5000869,  4,  4,  0,    0,  225,  203,  225,  248,   90,   90,  225,  135,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (5000869,  5,  4,  2, 0.75,  225,  203,  225,  248,   90,   90,  225,  135,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (5000869,  6,  4,  0,    0,  225,  203,  225,  248,   90,   90,  225,  135,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (5000869,  7,  4,  0,    0,  225,  203,  225,  248,   90,   90,  225,  135,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (5000869,  8,  4,  2, 0.75,  225,  203,  225,  248,   90,   90,  225,  135,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5000869, 3 /* Death */, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

SET @parent_id = LAST_INSERT_ID();

INSERT INTO `weenie_properties_emote_action` (`emote_Id`, `order`, `type`, `delay`, `extent`, `motion`, `message`, `test_String`, `min`, `max`, `min_64`, `max_64`, `min_Dbl`, `max_Dbl`, `stat`, `display`, `amount`, `amount_64`, `hero_X_P_64`, `percent`, `spell_Id`, `wealth_Rating`, `treasure_Class`, `treasure_Type`, `p_Script`, `sound`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (@parent_id, 0, 24 /* StopEvent */, 0, 1, NULL, 'YaraqAttack', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
     , (@parent_id, 1, 23 /* StartEvent */, 1, 1, NULL, 'YaraqWait', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
     , (@parent_id, 2, 16 /* WorldBroadcast */, 0, 1, NULL, 'Yaraq Has refused to fall to Cultist Darkness!!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (5000869, 9,   5002755,  0, 0, 1, False) /* Create nothing for ContainTreasure */
     , (5000869, 9,   5002755,  0, 0, 1, False) /* Create nothing for ContainTreasure */
     , (5000869, 9,   5002755,  0, 0, 1, False) /* Create nothing for ContainTreasure */
     , (5000869, 9,   5002755,  0, 0, 1, False) /* Create nothing for ContainTreasure */
     , (5000869, 9,   5002755,  0, 0, 1, False) /* Create nothing for ContainTreasure */
     , (5000869, 9,   5002755,  0, 0, 1, False) /* Create nothing for ContainTreasure */
