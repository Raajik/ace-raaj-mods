DELETE FROM `weenie` WHERE `class_Id` = 5000870;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (5000870, '5000870', 10, '2019-09-13 00:00:00') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (5000870,   1,         16) /* ItemType - Creature */
     , (5000870,   2,         31) /* CreatureType - Human */
     , (5000870,   6,         -1) /* ItemsCapacity */
     , (5000870,   7,         -1) /* ContainersCapacity */
     , (5000870,   8,        120) /* Mass */
     , (5000870,  16,          1) /* ItemUseable - No */
     , (5000870,  25,         80) /* Level */
     , (5000870,  27,          0) /* ArmorType - None */
     , (5000870,  68,         13) /* TargetingTactic - Random, LastDamager, TopDamager */
     , (5000870,  93,       1032) /* PhysicsState - ReportCollisions, Gravity */
     , (5000870, 101,        131) /* AiAllowedCombatStyle - Unarmed, OneHanded, ThrownWeapon */
     , (5000870, 113,          1) /* Gender - Male */
     , (5000870, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (5000870, 146,      30000) /* XpOverride */
     , (5000870, 188,          1) /* HeritageGroup - Aluvian */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5000870,   1, True ) /* Stuck */
     , (5000870,  11, False) /* IgnoreCollisions */
     , (5000870,  12, True ) /* ReportCollisions */
     , (5000870,  13, False) /* Ethereal */
     , (5000870,  14, True ) /* GravityStatus */
     , (5000870,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (5000870,   1,       5) /* HeartbeatInterval */
     , (5000870,   2,       0) /* HeartbeatTimestamp */
     , (5000870,   3,       2) /* HealthRate */
     , (5000870,   4,       5) /* StaminaRate */
     , (5000870,   5,       1) /* ManaRate */
     , (5000870,  13, 0.899999976158142) /* ArmorModVsSlash */
     , (5000870,  14,       1) /* ArmorModVsPierce */
     , (5000870,  15, 1.10000002384186) /* ArmorModVsBludgeon */
     , (5000870,  16, 0.400000005960464) /* ArmorModVsCold */
     , (5000870,  17, 0.400000005960464) /* ArmorModVsFire */
     , (5000870,  18,       1) /* ArmorModVsAcid */
     , (5000870,  19, 0.600000023841858) /* ArmorModVsElectric */
     , (5000870,  31,      12) /* VisualAwarenessRange */
     , (5000870,  64,       1) /* ResistSlash */
     , (5000870,  65,       1) /* ResistPierce */
     , (5000870,  66,       1) /* ResistBludgeon */
     , (5000870,  67,       1) /* ResistFire */
     , (5000870,  68,       1) /* ResistCold */
     , (5000870,  69,       1) /* ResistAcid */
     , (5000870,  70,       1) /* ResistElectric */
     , (5000870,  71,       1) /* ResistHealthBoost */
     , (5000870,  72,       1) /* ResistStaminaDrain */
     , (5000870,  73,       1) /* ResistStaminaBoost */
     , (5000870,  74,       1) /* ResistManaDrain */
     , (5000870,  75,       1) /* ResistManaBoost */
     , (5000870, 104,      10) /* ObviousRadarRange */
     , (5000870, 117,     0.5) /* FocusedProbability */
     , (5000870, 125,       1) /* ResistHealthDrain */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (5000870,   1, 'Cultist') /* Name */
     , (5000870,   3, 'Male') /* Sex */
     , (5000870,   4, 'Aluvian') /* HeritageGroup */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (5000870,   1,   33554433) /* Setup */
     , (5000870,   2,  150994945) /* MotionTable */
     , (5000870,   3,  536870913) /* SoundTable */
     , (5000870,   4,  805306368) /* CombatTable */
     , (5000870,   6,   67108990) /* PaletteBase */
     , (5000870,   8,  100667446) /* Icon */
     , (5000870,   9,   83890514) /* EyesTexture */
     , (5000870,  10,   83890562) /* NoseTexture */
     , (5000870,  11,   83890613) /* MouthTexture */
     , (5000870,  15,   67116993) /* HairPalette */
     , (5000870,  16,   67109567) /* EyesPalette */
     , (5000870,  17,   67109558) /* SkinPalette */
     , (5000870,  22,  872415236) /* PhysicsEffectTable */
     , (5000870,  32,        364) /* WieldedTreasureType - 
     ...
     , (5000870,  35,        450) /* DeathTreasureType - Loot Tier: 3 */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (5000870,   1, 190, 0, 0) /* Strength */
     , (5000870,   2, 100, 0, 0) /* Endurance */
     , (5000870,   3, 100, 0, 0) /* Quickness */
     , (5000870,   4, 100, 0, 0) /* Coordination */
     , (5000870,   5, 250, 0, 0) /* Focus */
     , (5000870,   6, 250, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (5000870,   1,   104, 0, 0, 154) /* MaxHealth */
     , (5000870,   3,   104, 0, 0, 204) /* MaxStamina */
     , (5000870,   5,   112, 0, 0, 362) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (5000870,  6, 0, 3, 0, 280, 0, 0) /* MeleeDefense        Specialized */
     , (5000870,  7, 0, 3, 0, 320, 0, 0) /* MissileDefense      Specialized */
     , (5000870, 15, 0, 3, 0, 180, 0, 0) /* MagicDefense        Specialized */
     , (5000870, 24, 0, 3, 0, 100, 0, 0) /* Run                 Specialized */
     , (5000870, 31, 0, 3, 0,  78, 0, 0) /* CreatureEnchantment Specialized */
     , (5000870, 33, 0, 3, 0,  78, 0, 0) /* LifeMagic           Specialized */
     , (5000870, 34, 0, 3, 0,  78, 0, 0) /* WarMagic            Specialized */
     , (5000870, 44, 0, 3, 0, 190, 0, 0) /* HeavyWeapons        Specialized */
     , (5000870, 45, 0, 3, 0, 190, 0, 0) /* LightWeapons        Specialized */
     , (5000870, 46, 0, 3, 0, 190, 0, 0) /* FinesseWeapons      Specialized */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (5000870,  0,  4,  0,    0,  270,  243,  270,  297,  108,  108,  270,  162,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (5000870,  1,  4,  0,    0,  260,  234,  260,  286,  104,  104,  260,  156,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (5000870,  2,  4,  0,    0,  260,  234,  260,  286,  104,  104,  260,  156,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (5000870,  3,  4,  0,    0,  250,  225,  250,  275,  100,  100,  250,  150,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (5000870,  4,  4,  0,    0,  250,  225,  250,  275,  100,  100,  250,  150,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (5000870,  5,  4,  2, 0.75,  250,  225,  250,  275,  100,  100,  250,  150,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (5000870,  6,  4,  0,    0,  250,  225,  250,  275,  100,  100,  250,  150,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (5000870,  7,  4,  0,    0,  250,  225,  250,  275,  100,  100,  250,  150,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (5000870,  8,  4,  2, 0.75,  250,  225,  250,  275,  100,  100,  250,  150,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (5000870, 2, 12193,  0, 86, 0, False) /* Create Dho Vest and Robe (12193) for Wield */
     , (5000870, 9,  6876,  0, 0, 0.02, False) /* Create Sturdy Iron Key (6876) for ContainTreasure */
     , (5000870, 9,     0,  0, 0, 0.98, False) /* Create nothing for ContainTreasure */;
