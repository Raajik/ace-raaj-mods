...
VALUES (5000322,   1,         16) /* ItemType - Creature */
     ...
     , (5000322,  25,        400) /* Level */
     , (5000322,  27,          0) /* ArmorType - None */
     , (5000322,  40,          2) /* CombatMode - Melee */
     , (5000322,  68,          0x80) /* TargetingTactic - Random, TopDamager */
     ...
     , (5000322, 146,    30001320) /* XpOverride */
...
VALUES (5000322,   1,       5) /* HeartbeatInterval */
     ...
     , (5000322, 125,    0.03) /* ResistHealthDrain */
     , (5000322, 166,    0.07) /* ResistNether */;
...
VALUES (5000322,   1,   33558554) /* Setup */
     , (5000322,   2,  150995263) /* MotionTable */
     , (5000322,   3,  536871080) /* SoundTable */
     , (5000322,   4,  805306426) /* CombatTable */
     , (5000322,   6,   67114728) /* PaletteBase */
     , (5000322,   7,  268436733) /* ClothingBase */
     , (5000322,   8,  100675661) /* Icon */
     , (5000322,  19,         85) /* ActivationAnimation */
     , (5000322,  22,  872415401) /* PhysicsEffectTable */
     , (5000322,  30,         85) /* PhysicsScript - BreatheFrost */
     , (5000322,  35,       2111) /* DeathTreasureType */;
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5000322,  5 /* HeartBeat */,  0.025, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5000322,  5 /* HeartBeat */,   0.05, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5000322,  5 /* HeartBeat */,  0.055, NULL, 2147483708 /* HandCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5000322,  5 /* HeartBeat */,  0.025, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5000322,  5 /* HeartBeat */,   0.05, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (5000322,  5 /* HeartBeat */,  0.055, NULL, 2147483709 /* NonCombat */, 1090519043 /* Ready */, NULL, NULL, NULL, NULL);
...
VALUES (5000339, 9, 300191,  0, 0, 0.2, True) /* Create Bone fragment (5000394) for ContainTreasure */;
