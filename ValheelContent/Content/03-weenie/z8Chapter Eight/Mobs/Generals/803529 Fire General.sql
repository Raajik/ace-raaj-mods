DELETE FROM `weenie` WHERE `class_Id` = 803529;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (803529, 'FireGeneral', 10, '2024-03-16 11:35:17') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (803529,   1,         16) /* ItemType - Creature */
     , (803529,   2,         62) /* CreatureType - Golem */
     , (803529,   3,         14) /* PaletteTemplate - White */
     , (803529,   6,         -1) /* ItemsCapacity */
     , (803529,   7,         -1) /* ContainersCapacity */
     , (803529,  16,          1) /* ItemUseable - No */
     , (803529,  25,       4000) /* Level */
     , (803529,  27,          1) /* ArmorType - Cloth */
     , (803529,  40,          2) /* CombatMode - Melee */
     , (803529,  68,       0x80) /* TargetingTactic - Random, LastDamager, TopDamager */
     , (803529,  93,       1032) /* PhysicsState - ReportCollisions, Gravity */
     , (803529, 101,        131) /* AiAllowedCombatStyle - Unarmed, OneHanded, ThrownWeapon */
     , (803529, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (803529, 140,          1) /* AiOptions - CanOpenDoors */
     , (803529, 146,     825000) /* XpOverride */
     , (803529, 332,     825000) /* LuminanceAward */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (803529,   1, False) /* Stuck */
     , (803529,   6, True ) /* AiUsesMana */
     , (803529,  11, False) /* IgnoreCollisions */
     , (803529,  12, True ) /* ReportCollisions */
     , (803529,  13, False) /* Ethereal */
     , (803529,  19, True ) /* Attackable */
     , (803529,  50, True ) /* NeverFailCasting */
     , (803529,  65, True ) /* IgnoreMagicResist */
     , (803529,  66, True ) /* IgnoreMagicArmor */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (803529,   1,       5) /* HeartbeatInterval */
     , (803529,   2,       0) /* HeartbeatTimestamp */
     , (803529,   3,     0.4) /* HealthRate */
     , (803529,   4,       5) /* StaminaRate */
     , (803529,   5,       1) /* ManaRate */
     , (803529,  13,       5) /* ArmorModVsSlash */
     , (803529,  14,       5) /* ArmorModVsPierce */
     , (803529,  15,       5) /* ArmorModVsBludgeon */
     , (803529,  16,       5) /* ArmorModVsCold */
     , (803529,  17,       5) /* ArmorModVsFire */
     , (803529,  18,       5) /* ArmorModVsAcid */
     , (803529,  19,       5) /* ArmorModVsElectric */
     , (803529,  31,      30) /* VisualAwarenessRange */
     , (803529,  34,       1) /* PowerupTime */
     , (803529,  36,       1) /* ChargeSpeed */
     , (803529,  39,     1.8) /* DefaultScale */
     , (803529,  64,   0.001) /* ResistSlash */
     , (803529,  65,   0.001) /* ResistPierce */
     , (803529,  66,   0.001) /* ResistBludgeon */
     , (803529,  67,   0.001) /* ResistFire */
     , (803529,  68,   0.003) /* ResistCold */
     , (803529,  69,   0.001) /* ResistAcid */
     , (803529,  70,   0.001) /* ResistElectric */
     , (803529,  71,       1) /* ResistHealthBoost */
     , (803529,  72,       1) /* ResistStaminaDrain */
     , (803529,  73,       1) /* ResistStaminaBoost */
     , (803529,  74,       1) /* ResistManaDrain */
     , (803529,  75,       1) /* ResistManaBoost */
     , (803529,  80,       3) /* AiUseMagicDelay */
     , (803529, 104,      10) /* ObviousRadarRange */
     , (803529, 117,     0.5) /* FocusedProbability */
     , (803529, 122,       2) /* AiAcquireHealth */
     , (803529, 125,   0.002) /* ResistHealthDrain */
     , (803529, 166,   0.002) /* ResistNether */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (803529,   1, 'Fire General') /* Name */
     , (803529,  45, 'ENTER') /* KillQuest */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (803529,   1,   33559683) /* Setup */
     , (803529,   2,  150994945) /* MotionTable */
     , (803529,   3,  536870998) /* SoundTable */
     , (803529,   4,  805306368) /* CombatTable */
     , (803529,   6,   67116522) /* PaletteBase */
     , (803529,   7,  268437042) /* ClothingBase */
     , (803529,   8,  100670274) /* Icon */
     , (803529,  22,  872415349) /* PhysicsEffectTable */
     , (803529,  35,       5000) /* DeathTreasureType */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (803529,  0, 32,     0,    0,  40000,  318,  335,  318,  335,  335,  335,  285,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (803529,  1, 32,     0,    0,  40000,  318,  335,  318,  335,  335,  335,  285,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (803529,  2, 32,     0,    0,  40000,  318,  335,  318,  335,  335,  335,  285,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (803529,  3, 32,     0,    0,  40000,  318,  335,  318,  335,  335,  335,  285,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (803529,  4, 32,     0,    0,  40000,  318,  335,  318,  335,  335,  335,  285,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (803529,  5, 32, 65000, 0.75,  40000,  318,  335,  318,  335,  335,  335,  285,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (803529,  6, 32,     0,    0,  40000,  318,  335,  318,  335,  335,  335,  285,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (803529,  7, 32,     0,    0,  40000,  318,  335,  318,  335,  335,  335,  285,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (803529,  8, 32, 65000, 0.75,  40000,  318,  335,  318,  335,  335,  335,  285,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (803529,   1,27000, 0, 0) /* Strength */
     , (803529,   2,27000, 0, 0) /* Endurance */
     , (803529,   3, 550, 0, 0) /* Quickness */
     , (803529,   4, 500, 0, 0) /* Coordination */
     , (803529,   5, 540, 0, 0) /* Focus */
     , (803529,   6, 590, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (803529,   1,4750000, 0, 0,4750000) /* MaxHealth */
     , (803529,   3, 750000, 0, 0,750000) /* MaxStamina */
     , (803529,   5, 750000, 0, 0,750000) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (803529,  6, 0, 3, 0,2300, 0, 0) /* MeleeDefense        Specialized */
     , (803529,  7, 0, 3, 0,1375, 0, 0) /* MissileDefense      Specialized */
     , (803529, 14, 0, 3, 0, 220, 0, 0) /* ArcaneLore          Specialized */
     , (803529, 15, 0, 3, 0, 600, 0, 0) /* MagicDefense        Specialized */
     , (803529, 20, 0, 3, 0, 100, 0, 0) /* Deception           Specialized */
     , (803529, 31, 0, 3, 0,2000, 0, 0) /* CreatureEnchantment Specialized */
     , (803529, 33, 0, 3, 0,2000, 0, 0) /* LifeMagic           Specialized */
     , (803529, 34, 0, 3, 0,2000, 0, 0) /* WarMagic            Specialized */
     , (803529, 45, 0, 3, 0,2000, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 3 /* Death */, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 12 /* QuestSuccess */, 1, NULL, NULL, NULL, 'Prestige@10000_108', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 13 /* QuestFailure */, 1, NULL, NULL, NULL, 'Prestige@10000_108', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 22 /* TestSuccess */, 1, NULL, NULL, NULL, 'OwnsItem-803376_48', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 32 /* GotoSet */, 1, NULL, NULL, NULL, 'InstaRepPlus', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 23 /* TestFailure */, 1, NULL, NULL, NULL, 'OwnsItem-803376_48', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 22 /* TestSuccess */, 1, NULL, NULL, NULL, 'OwnsItem-802609_86', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 23 /* TestFailure */, 1, NULL, NULL, NULL, 'OwnsItem-802609_86', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 22 /* TestSuccess */, 1, NULL, NULL, NULL, '9018_94', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 23 /* TestFailure */, 1, NULL, NULL, NULL, '9018_94', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 32 /* GotoSet */, 0.5, NULL, NULL, NULL, 'RepRoll', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 32 /* GotoSet */, 1, NULL, NULL, NULL, 'InstaRep', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 32 /* GotoSet */, 0.1, NULL, NULL, NULL, 'BlessRoll', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 32 /* GotoSet */, 0.01, NULL, NULL, NULL, 'RatingRoll', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 12 /* QuestSuccess */, 1, NULL, NULL, NULL, 'MobRatings@1000_10', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803529, 13 /* QuestFailure */, 1, NULL, NULL, NULL, 'MobRatings@1000_10', NULL, NULL, NULL);
...
VALUES (803529, 9,803254,  0, 0, 0.05, False) /* Create Scalemark for ContainTreasure */
     , (803529, 9,     0,  0, 0, 0.95, False) /* Create Nothing for ContainTreasure */
     , (803529, 9,803513,  0, 0,    1, False) /* Create CausticPlans for ContainTreasure */
     , (803529, 9,803513,  0, 0,    1, False) /* Create CausticPlans for ContainTreasure */
     , (803529, 9,803513,  0, 0,    1, False) /* Create CausticPlans for ContainTreasure */
     , (803529, 9,803513,  0, 0,    1, False) /* Create CausticPlans for ContainTreasure */
     , (803529, 9,803513,  0, 0,    1, False) /* Create CausticPlans for ContainTreasure */
