DELETE FROM `weenie` WHERE `class_Id` = 803967;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (803967, 'Blighted Reaver1', 10, '2024-03-16 11:35:17') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (803967,   1,         16) /* ItemType - Creature */
     , (803967,   2,         16) /* CreatureType - Golem */
     , (803967,   3,          2) /* PaletteTemplate - White */
     , (803967,   6,         -1) /* ItemsCapacity */
     , (803967,   7,         -1) /* ContainersCapacity */
     , (803967,  16,          1) /* ItemUseable - No */
     , (803967,  25,       4000) /* Level */
     , (803967,  27,          1) /* ArmorType - Cloth */
     , (803967,  40,          2) /* CombatMode - Melee */
     , (803967,  68,       0x80) /* TargetingTactic - Random, LastDamager, TopDamager */
     , (803967,  93,       1032) /* PhysicsState - ReportCollisions, Gravity */
     , (803967, 101,        131) /* AiAllowedCombatStyle - Unarmed, OneHanded, ThrownWeapon */
     , (803967, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (803967, 140,          1) /* AiOptions - CanOpenDoors */
     , (803967, 146,     825000) /* XpOverride */
     , (803967, 332,     825000) /* LuminanceAward */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (803967,   1, False) /* Stuck */
     , (803967,   6, True ) /* AiUsesMana */
     , (803967,  11, False) /* IgnoreCollisions */
     , (803967,  12, True ) /* ReportCollisions */
     , (803967,  13, False) /* Ethereal */
     , (803967,  19, True ) /* Attackable */
     , (803967,  50, True ) /* NeverFailCasting */
     , (803967,  65, True ) /* IgnoreMagicResist */
     , (803967,  66, True ) /* IgnoreMagicArmor */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (803967,   1,       5) /* HeartbeatInterval */
     , (803967,   2,       0) /* HeartbeatTimestamp */
     , (803967,   3,     0.4) /* HealthRate */
     , (803967,   4,       5) /* StaminaRate */
     , (803967,   5,       1) /* ManaRate */
     , (803967,  13,       5) /* ArmorModVsSlash */
     , (803967,  14,       5) /* ArmorModVsPierce */
     , (803967,  15,       5) /* ArmorModVsBludgeon */
     , (803967,  16,       5) /* ArmorModVsCold */
     , (803967,  17,       5) /* ArmorModVsFire */
     , (803967,  18,       5) /* ArmorModVsAcid */
     , (803967,  19,       5) /* ArmorModVsElectric */
     , (803967,  31,      30) /* VisualAwarenessRange */
     , (803967,  34,       1) /* PowerupTime */
     , (803967,  36,       1) /* ChargeSpeed */
     , (803967,  39,     1.3) /* DefaultScale */
     , (803967,  64,   0.003) /* ResistSlash */
     , (803967,  65,   0.003) /* ResistPierce */
     , (803967,  66,   0.001) /* ResistBludgeon */
     , (803967,  67,   0.001) /* ResistFire */
     , (803967,  68,   0.001) /* ResistCold */
     , (803967,  69,   0.001) /* ResistAcid */
     , (803967,  70,   0.001) /* ResistElectric */
     , (803967,  71,       1) /* ResistHealthBoost */
     , (803967,  72,       1) /* ResistStaminaDrain */
     , (803967,  73,       1) /* ResistStaminaBoost */
     , (803967,  74,       1) /* ResistManaDrain */
     , (803967,  75,       1) /* ResistManaBoost */
     , (803967,  80,       3) /* AiUseMagicDelay */
     , (803967, 104,      10) /* ObviousRadarRange */
     , (803967, 117,     0.5) /* FocusedProbability */
     , (803967, 122,       2) /* AiAcquireHealth */
     , (803967, 125,   0.002) /* ResistHealthDrain */
     , (803967, 166,   0.002) /* ResistNether */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (803967,   1, 'Blighted Reaver') /* Name */
     , (803967,  45, 'blightedreaverKT') /* KillQuest */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (803967,   1,   33554489) /* Setup */
     , (803967,   2,  150994970) /* MotionTable */
     , (803967,   3,  536870928) /* SoundTable */
     , (803967,   4,  805306378) /* CombatTable */
     , (803967,   6,   67109313) /* PaletteBase */
     , (803967,   7,  268435556) /* ClothingBase */
     , (803967,   8,  100667939) /* Icon */
     , (803967,  22,  872415268) /* PhysicsEffectTable */
     , (803967,  35,       5000) /* DeathTreasureType */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (803967,  0,  2, 65000, 0.75,  40000,  300,  250,  375,  500,  400,  325,  500,    0, 2,  0.4,  0.1,    0,  0.4,  0.1,    0,    0,    0,    0,    0,    0,    0) /* Head */
     , (803967, 10,  2, 65000,  0.5,  40000,  300,  250,  375,  500,  400,  325,  500,    0, 2,    0,  0.2,  0.8,    0,  0.2,  0.8,    0,    0,    0,    0,    0,    0) /* FrontLeg */
     , (803967, 13,  2, 65000,  0.5,  40000,  300,  250,  375,  500,  400,  325,  500,    0, 3,    0,    0,    0,    0,    0,    0,  0.1,  0.3,  0.7,  0.1,  0.3,  0.7) /* RearLeg */
     , (803967, 16,  4, 65000,    0,  40000,  300,  250,  375,  500,  400,  325,  500,    0, 2,  0.6,  0.7,  0.2,  0.6,  0.7,  0.2,  0.9,  0.7,  0.3,  0.9,  0.7,  0.3) /* Torso */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (803967,   1,27000, 0, 0) /* Strength */
     , (803967,   2,27000, 0, 0) /* Endurance */
     , (803967,   3, 550, 0, 0) /* Quickness */
     , (803967,   4, 500, 0, 0) /* Coordination */
     , (803967,   5, 540, 0, 0) /* Focus */
     , (803967,   6, 590, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (803967,   1,4750000, 0, 0,4750000) /* MaxHealth */
     , (803967,   3, 750000, 0, 0,750000) /* MaxStamina */
     , (803967,   5, 750000, 0, 0,750000) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (803967,  6, 0, 3, 0,2300, 0, 0) /* MeleeDefense        Specialized */
     , (803967,  7, 0, 3, 0,1375, 0, 0) /* MissileDefense      Specialized */
     , (803967, 14, 0, 3, 0, 220, 0, 0) /* ArcaneLore          Specialized */
     , (803967, 15, 0, 3, 0, 600, 0, 0) /* MagicDefense        Specialized */
     , (803967, 20, 0, 3, 0, 100, 0, 0) /* Deception           Specialized */
     , (803967, 31, 0, 3, 0,2000, 0, 0) /* CreatureEnchantment Specialized */
     , (803967, 33, 0, 3, 0,2000, 0, 0) /* LifeMagic           Specialized */
     , (803967, 34, 0, 3, 0,2000, 0, 0) /* WarMagic            Specialized */
     , (803967, 45, 0, 3, 0,2000, 0, 0) /* LightWeapons        Specialized */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803967, 3 /* Death */, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803967, 12 /* QuestSuccess */, 1, NULL, NULL, NULL, 'Prestige@10000_108', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803967, 13 /* QuestFailure */, 1, NULL, NULL, NULL, 'Prestige@10000_108', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803967, 22 /* TestSuccess */, 1, NULL, NULL, NULL, 'OwnsItem-803376', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803967, 32 /* GotoSet */, 1, NULL, NULL, NULL, 'InstaRepPlus', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803967, 23 /* TestFailure */, 1, NULL, NULL, NULL, 'OwnsItem-803376', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803967, 32 /* GotoSet */, 0.1, NULL, NULL, NULL, 'BlessRoll', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803967, 32 /* GotoSet */, 0.01, NULL, NULL, NULL, 'RatingRoll', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803967, 13 /* QuestFailure */, 1, NULL, NULL, NULL, 'MobRatings2@1000', NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803967, 14 /* Taunt */, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (803967, 22 /* TestSuccess */, 1, NULL, NULL, NULL, 'AvailableLuminance_300000000_6', NULL, NULL, NULL);
