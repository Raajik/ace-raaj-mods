...
SELECT 'OK' as status, COUNT(*) as rows FROM weenie_properties_int WHERE type = 100 AND object_Id IN (22419,22420,22421,22422,22423,22424,22425,22426,22427,22428,22429,22430,22431,22432,51351,19478,28718,28719,28725,28726,28727,42104,22729,51372);