-- Mana Lattice (850201) — gem-style self-use from pack (ItemUseable Contained, Target Creature), CastSpell + spellbook.
-- Matches SpellSiphon Content/SQL/ManaLattice_Create.sql for template fields.
...
VALUES (850201, 'manalattice', 38, '2026-05-03 00:00:00') /* Gem */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES
 (850201,   1,     2048) /* ItemType - Gem */
