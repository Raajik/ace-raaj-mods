...
## SQL denylist
- `weenie_properties_create_list.object_Id` joins **`weenie.class_Id`** (ACE `weenie` has no `id` column); filter vendors with `weenie.class_Id NOT IN (850300,850301,850302,850303)`.
