...
) ENGINE=InnoDB AUTO_INCREMENT=7321 DEFAULT CHARSET=utf8mb3 COMMENT='EventFilter Properties of Weenies';
/*!40101 SET character_set_client = @saved_cs_client */;

LOCK TABLES `weenie_properties_event_filter` WRITE;
/*!40000 ALTER TABLE `weenie_properties_event_filter` DISABLE KEYS */;
/*!40000 ALTER TABLE `weenie_properties_event_filter` ENABLE KEYS */;
UNLOCK TABLES;
