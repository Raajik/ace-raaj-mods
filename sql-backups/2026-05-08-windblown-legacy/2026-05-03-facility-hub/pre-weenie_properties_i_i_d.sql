...
) ENGINE=InnoDB AUTO_INCREMENT=257 DEFAULT CHARSET=utf8mb3 COMMENT='InstanceID Properties of Weenies';
/*!40101 SET character_set_client = @saved_cs_client */;

LOCK TABLES `weenie_properties_i_i_d` WRITE;
/*!40000 ALTER TABLE `weenie_properties_i_i_d` DISABLE KEYS */;
/*!40000 ALTER TABLE `weenie_properties_i_i_d` ENABLE KEYS */;
UNLOCK TABLES;
