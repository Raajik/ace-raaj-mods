...
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8mb3 COMMENT='Palette Changes (from PCAPs) of Weenies';
/*!40101 SET character_set_client = @saved_cs_client */;

LOCK TABLES `weenie_properties_palette` WRITE;
/*!40000 ALTER TABLE `weenie_properties_palette` DISABLE KEYS */;
/*!40000 ALTER TABLE `weenie_properties_palette` ENABLE KEYS */;
UNLOCK TABLES;
