...
) ENGINE=InnoDB AUTO_INCREMENT=59518 DEFAULT CHARSET=utf8mb3 COMMENT='SpellBook Properties of Weenies';
/*!40101 SET character_set_client = @saved_cs_client */;

LOCK TABLES `weenie_properties_spell_book` WRITE;
/*!40000 ALTER TABLE `weenie_properties_spell_book` DISABLE KEYS */;
/*!40000 ALTER TABLE `weenie_properties_spell_book` ENABLE KEYS */;
UNLOCK TABLES;
